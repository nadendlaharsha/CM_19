...
class EngagementFuser:
    ...
    def extract_fusion_keyframes(self, transcript_with_timestamps, num_keyframes=5):
        ...
        for _, row in fused_df.iterrows():
            ...
            # Aggregate context around the highlight (e.g., +/- 30 seconds)
            start_time = row['start'] - 30
            end_time = row['start'] + 30
            context_texts = []
            ...
            context_text = " ".join(context_texts) if context_texts else row['text']
